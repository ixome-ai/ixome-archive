            ...
            <div class="article-content">
              <div class="entry-meta">
                <ul>
                  ...
                  <li><UserIcon></UserIcon> <a href="#">Steven Smith</a></li>
                </ul>
              </div>
              ...
              <ul class="features-list">
                <li>
                  <CheckIcon></CheckIcon> Scientific Skills For getting a better
                  result
                </li>
                <li>
                  <CheckIcon></CheckIcon> Communication Skills to getting in
                  touch
                </li>
                <li>
                  <CheckIcon></CheckIcon> A Career Overview opportunity
                  Available
                </li>
                <li>
                  <CheckIcon></CheckIcon> A good Work Environment For work
                </li>
              </ul>
                  ...
                  <a href="#">
                    ...
                    <span class="prev-link-info-wrapper">
                      <span class="prev-title"
                        >Don't buy a tech gift until you read these rules</span
                      >
