        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="single-pricing-table">
            ...
            <div class="pricing-features">
              <ul>
                <li><CheckIcon></CheckIcon> 99.9% Uptime Guarantee</li>
                <li><CheckIcon></CheckIcon> Reliable & Secure</li>
                <li><CheckIcon></CheckIcon> Powered by cPanel / Plesk</li>
                <li><CheckIcon></CheckIcon> Web Asset Delivery</li>
                <li><CheckIcon></CheckIcon> 24/7 Dedicated Support</li>
              </ul>
            </div>
