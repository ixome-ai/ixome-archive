                        ...
                        <div class="blog-details-desc">
                            ...
                            <div class="article-content">
                                <div class="entry-meta">
                                    <ul>
                                        <li><vue-feather type="clock"></vue-feather> <a href="#">September 31, 2022</a></li>
                                        <li><vue-feather type="user"></vue-feather> <a href="#">Steven Smith</a></li>
                                    </ul>
                                </div>
                                ...
                                <ul class="features-list">
                                    <li><vue-feather type="check"></vue-feather> Scientific Skills For getting a better result</li>
                                    <li><vue-feather type="check"></vue-feather> Communication Skills to getting in touch</li>
                                    <li><vue-feather type="check"></vue-feather> A Career Overview opportunity Available</li>
                                    <li><vue-feather type="check"></vue-feather> A good Work Environment For work</li>
                                </ul>
                                        ...
                                        <ol class="children">
                                            <li class="comment">
                                                <article class="comment-body">
                                                    <footer class="comment-meta">
                                                        <div class="comment-author vcard">
															<img src="../../../assets/img/client-image/5.jpg" class="avatar" alt="image">
                        ...
                        <aside class="widget-area" id="secondary">
                            <section class="widget widget_search">
                                <form class="search-form">
                                    ...
                                    <button type="submit"><vue-feather type="search"></vue-feather></button>
                                </form>
                            </section>
